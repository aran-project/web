  ...
  >
    ...
    <div className="mx-auto mt-8 max-w-screen-2xl px-8">
      <div className="grid grid-cols-8 divide-y-2  divide-gray-200  md:-mx-8 md:grid-cols-9 md:divide-x-2 md:divide-y-0 lg:grid-cols-8">
          ...
          <nav className="mt-4">
            <ul className="space-y-2">
              <li>
                <a
                  href="#"
                  className="text-base font-normal hover:text-gray-400"
                >
                  Landingpages
                </a>
              </li>
        ...
        <div className="col-span-8 py-4 md:col-span-3 md:px-8 md:py-0 lg:col-span-3">
          ...
          <nav className="mt-4">
            <ul className="grid lg:grid-cols-2">
              <li className="mb-2">
                <a
                  href="#"
                  className="flex space-x-2 text-base font-normal hover:text-gray-400"
                >
                  <svg
                    className="h-6 w-6"
                    aria-hidden="true"
