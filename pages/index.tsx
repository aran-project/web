...
const categories = [
  {
    ...
    desc: 'The Entry To your Home',
  },
  {
    name: 'Windows',
    desc: 'Peek outside a Bit!',

    thumb:
      'https://www.howtogeek.com/wp-content/uploads/2019/05/img_5cf05d111ada0.png?height=200p&trim=2,2,2,2&crop=16:9',
  },

  {
    name: 'Basic',
    desc: 'The Stuff to Make Your Home home!',
    thumb:
      ...
      <div className="relative mt-8 h-auto w-screen py-4 ">
        ...
        <div className="z-50 max-w-2xl  py-4 px-4  sm:px-6 lg:max-w-7xl lg:px-8 ">
          <div className="mt-6  grid  grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-1 lg:grid-cols-4 xl:gap-x-8">
            {categories.map((cat) => (
              <Link href={`/shop/${cat.name as string}`} key={cat.name}>
                <a className="">
